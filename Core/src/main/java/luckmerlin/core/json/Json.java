...
public class Json extends JSONObject {
    ...
    public Json(String jsonText) throws JSONException {
        super(null!=jsonText&&jsonText.length()>0?jsonText:new JSONObject().toString());
    }
    ...
    public final String getText(String key,String def){
    ...
    public final Json putValueSafe(String key, Object value) {
        return putJsonValueSafe(this,key,value);
    }

    public final<T extends JSONObject> T  putJsonValueSafe(T jsonObject,String key,Object value) {
